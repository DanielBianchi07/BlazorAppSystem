...
namespace BlazorApp.Web.Handlers
{
    public class TreinamentoHandler(IHttpClientFactory httpClientFactory) : ITreinamentoHandler
    {
        ...
        {
            var result = await _httpClient.PostAsJsonAsync("v1/treinamento", request);
        ...
        {
            var result = await _httpClient.DeleteAsync($"v1/treinamento/{request.Id}");
            return await result.Content.ReadFromJsonAsync<Response<Treinamento?>>()
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetAllAsync(GetAllTreinamentosRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetByDateAsync(GetTreinamentoByDateRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/data/{request.StartDate}-{request.EndDate}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByAlunoAsync(GetTreinamentoByAlunoRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/aluno/{request.AlunoId}")
        ...
        public async Task<Response<Treinamento?>> GetByIdAsync(GetTreinamentoByIdRequest request)
            => await _httpClient.GetFromJsonAsync<Response<Treinamento?>>($"v1/treinamento/{request.Id}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByAlunoByDateAsync(GetTreinamentoByAlunoByDateRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/aluno/{request.AlunoId}/data/{request.StartDate}-{request.EndDate}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByEmpresaAsync(GetTreinamentoByEmpresaRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/empresa/{request.EmpresaId}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByEmpresaByDateAsync(GetTreinamentoByEmpresaByDateRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/empresa/{request.EmpresaId}/data/{request.StartDate}-{request.EndDate}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByInstrutorAsync(GetTreinamentoByInstrutorRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/instrutor/{request.InstrutorId}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoByInstrutorByDateAsync(GetTreinamentoByInstrutorByDateRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/instrutor/{request.InstrutorId}/data/{request.StartDate}-{request.EndDate}")
        ...
        public async Task<PagedResponse<List<Treinamento>?>> GetTreinamentoBySitucaoAsync(GetTreinamentoBySituacaoRequest request)
            => await _httpClient.GetFromJsonAsync<PagedResponse<List<Treinamento>?>>($"v1/treinamento/situacao/{request.Situacao}")
        ...
        {
            var result = await _httpClient.PutAsJsonAsync($"v1/treinamento/{request.Id}", request);
            return await result.Content.ReadFromJsonAsync<Response<Treinamento?>>()
